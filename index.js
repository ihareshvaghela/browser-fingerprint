// import WebRTCUniqueId from "./webRTC";
import { getAudioFingerPrint } from "./getAudioFingerPrint.js";
...
export const getDeviceId = () => {
  ...
  */
  ...
  const audioFingerPrint = new Promise((resolve, reject) => {
    getAudioFingerPrint.run(function (fingerprint) {
      resolve(fingerprint);
    });
  });
  ...
  const AudioCanvasFingerPrint = new Promise((resolve, reject) => {
    audioFingerPrint.then((audioChannelResult) => {
      ...
      resolve(canvasFingerPrint + audioChannelResult.toString());
    });
  });
